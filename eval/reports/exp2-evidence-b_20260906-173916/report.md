# Eval Report: exp2-evidence-b

## Run config

| 항목 | 값 |
|---|---|
| started_at | 2026-09-06T17:36:16+09:00 |
| git_sha | 704fc98 |
| chat_model | gpt-4.1 |
...
| 지표 | 평균 | n |
|---|---|---|
| faithfulness | 0.995 | 24 |
| correctness | 0.677 | 32 |
| answer_relevance | 0.723 | 24 |
...
|---|---|---|---|---|---|---|---|---|
| factual | 8 | 0.604 | 0.688 | 0.083 | 1.000 | 0.521 | 0.814 | 12.5% |
| multi_evidence | 4 | 0.500 | 0.750 | 0.097 | 0.958 | 0.167 | 0.739 | 25.0% |
| procedural | 6 | 0.347 | 0.583 | 0.093 | 1.000 | 0.611 | 0.623 | 16.7% |
| reasoning | 4 | 0.500 | 0.425 | 0.057 | 1.000 | 0.792 | 0.688 | 0.0% |
| summary | 4 | 0.812 | 1.000 | 0.321 | 1.000 | 1.000 | 0.745 | 0.0% |
| unanswerable_in | 3 | - | - | - | - | 1.000 | - | 100.0% |
| unanswerable_out | 3 | - | - | 0.019 | 1.000 | 1.000 | 0.590 | 66.7% |

## Human alignment (수동 라벨 vs Judge)

| 지표 | n | 일치율 | Cohen's κ |
|---|---|---|---|
| faithfulness (임계값 0.8) | 22 | 95.5% | 0.000 |
