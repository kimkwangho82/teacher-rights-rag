# Eval Report: baseline-a

## Run config

| 항목 | 값 |
|---|---|
| started_at | 2026-09-06T17:04:43+09:00 |
| git_sha | 704fc98 |
| chat_model | gpt-4.1 |
...
| 지표 | 평균 | n |
|---|---|---|
| faithfulness | 0.971 | 23 |
| correctness | 0.651 | 32 |
| answer_relevance | 0.737 | 24 |
...
|---|---|---|---|---|---|---|---|---|
| factual | 8 | 0.604 | 0.688 | 0.083 | 1.000 | 0.521 | 0.819 | 12.5% |
| multi_evidence | 4 | 0.500 | 0.750 | 0.097 | 0.958 | 0.167 | 0.754 | 0.0% |
| procedural | 6 | 0.347 | 0.583 | 0.093 | 0.875 | 0.556 | 0.646 | 33.3% |
| reasoning | 4 | 0.500 | 0.425 | 0.057 | 1.000 | 0.667 | 0.682 | 0.0% |
| summary | 4 | 0.812 | 1.000 | 0.321 | 1.000 | 1.000 | 0.712 | 0.0% |
...
|---|---|---|
| faithfulness | 0.025 | 87.0% |
| correctness | 0.000 | 100.0% |
...
- **q016** (multi_evidence) 교육활동 침해학생에 대한 조치와 침해 보호자 등에 대한 조치는 종류가 어떻게 다른가요?  
  → recall 0.00; correct 0.00 (실패: 보호자 등: 서면사과 및 재발방지 서약, 특별교육 이수 또는 심리치료 2가지)
