# Eval Report: exp1-hybrid-a

## Run config

| 항목 | 값 |
|---|---|
| started_at | 2026-09-06T17:17:38+09:00 |
| git_sha | 704fc98 |
| chat_model | gpt-4.1 |
...
| 지표 | 평균 | n |
|---|---|---|
| faithfulness | 0.923 | 26 |
| correctness | 0.755 | 32 |
| answer_relevance | 0.745 | 26 |
...
| multi_evidence | 4 | 0.646 | 1.000 | 0.082 | 0.958 | 0.417 | 0.757 | 0.0% |
| procedural | 6 | 0.472 | 0.700 | 0.066 | 0.900 | 0.611 | 0.757 | 16.7% |
| reasoning | 4 | 0.875 | 0.875 | 0.064 | 1.000 | 0.917 | 0.644 | 0.0% |
| summary | 4 | 0.812 | 0.708 | 0.126 | 1.000 | 0.875 | 0.709 | 0.0% |
| unanswerable_in | 3 | - | - | 0.040 | 0.750 | 0.667 | 0.808 | 66.7% |
...
| correctness (임계값 0.5) | 32 | 87.5% | 0.592 |
...
- **q032** (unanswerable_in) 교육활동 침해 피해교원이 특별휴가를 사용하는 기간의 급여는 어떻게 처리되나요?  
  → 답 없는 질의에 답변; faith 0.75 (미지지: 특별휴가 사용 시 급여가 정상적으로 지급된다.); correct 0.00 (실패: 답변 불가 또는 정보 불충분을 표시)
